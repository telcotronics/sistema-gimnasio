    ...
    <form v-if="membresia" @submit.prevent="actualizarMembresia" class="form-container">
      <div class="form-grid">
        <div class="form-group">
          ...
          <input v-model="membresia.Nombre" id="Nombre" type="text" required class="form-input"
        ...
        <div class="form-group">
          ...
          <input v-model="membresia.Grupo" id="Grupo" type="text" class="form-input" placeholder="Ingrese el grupo" />
        </div>
        ...
        <div class="form-group">
          ...
          <input v-model="membresia.Fecha_Inicio" id="Fecha_Inicio" type="date" class="form-input" />
        </div>
        ...
        <div class="form-group">
          ...
          <input v-model="membresia.Fecha_Fin" id="Fecha_Fin" type="date" class="form-input" />
        </div>
        ...
        <div class="form-group">
          ...
          <input v-model.number="membresia.Valor" id="Valor" type="number" step="0.01" class="form-input"
            placeholder="0.00" />
        </div>
...
export default {
  ...
  methods: {
    async cargarMembresia() {
      const id = this.$route.params.id
      try {
        this.membresia = await ApiService.get(`api/tipos-membresia/${id}`)
      } catch (err) {
    ...
    async actualizarMembresia() {
      ...
      this.enviando = true
      try {
        await ApiService.put(`api/tipos-membresia/${id}`, this.membresia)
        this.mensaje = 'Membresía actualizada correctamente'
        setTimeout(() => { this.mensaje = '' }, 3000)
      } catch (err) {
        this.error = 'Error al actualizar membresía'
      } finally {
        this.enviando = false
      }
    },
